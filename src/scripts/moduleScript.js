...
function displayMore() {
  visibleSummaries += 2; // Augmente le nombre de résumés visibles
  if (visibleSummaries >= moduleSummaries.length) {
    document.querySelector('button[onclick="displayMore()"]').style.display = 'none'; // Cache le bouton si tous les résumés sont affichés
  }
  renderSummaries(); // Rendu des résumés
}
