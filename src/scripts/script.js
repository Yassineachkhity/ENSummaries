const summariesData = [
  { title: 'Back end', course: 'CI2 - IAGI', views: 400, author: '@Taha', likes: 344 },
  { title: 'Front end', course: 'CI2 - IAGI', views: 224, author: '@Ahmed', likes: 203 }
];
  ...
  summariesData.forEach((item, index) => {
    ...
    summaryElement.innerHTML = `
      ...
      <div class="flex items-center space-x-6">
        ...
        <button onclick="openCommentModal(${index})" class="flex items-center text-gray-600 hover:text-primary transition-colors">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 4.5C7.305 4.5 3.135 7.61 1.5 12c1.635 4.39 5.805 7.5 10.5 7.5s8.865-3.11 10.5-7.5c-1.635-4.39-5.805-7.5-10.5-7.5zm0 13c-2.485 0-4.5-2.015-4.5-4.5s2.015-4.5 4.5-4.5 4.5 2.015 4.5 4.5-2.015 4.5-4.5 4.5zm0-7.5c-1.655 0-3 1.345-3 3s1.345 3 3 3 3-1.345 3-3-1.345-3-3-3z"/></svg>
